...
export const TitleH2: React.FC<TitleH2PagesProps> = ({ title, description }) => {
  ...
  return (
    ...
    >
      <motion.h2
        className={`text-4xl lg:text-6xl xl:text-8xl font-extrabold bg-gradient-to-r ${gradient.from} ${gradient.to} text-transparent bg-clip-text uppercase mb-2 transition-colors duration-300`}
        initial={{ scale: 0.8 }}
